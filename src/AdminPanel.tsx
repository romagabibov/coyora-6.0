...
export default function AdminPanel({ onClose }: AdminPanelProps) {
  ...
  const [appStatusFilter, setAppStatusFilter] = useState<'applied' | 'approved' | 'rejected' | 'finalized' | 'deleted'>('applied');
  ...
  const loadApplications = async (formId: string, loadMore = false, searchQuery = '', forceRefresh = false) => {
    ...
    try {
      ...
      let newApps = newAppsData.map((app: any) => {
          return {
              ...app,
              ...
              {!isAuthenticated ? (
                ...
                <>
                  ...
                  <div className="flex flex-col md:flex-row flex-1 overflow-hidden bg-[#f9fafb]">
                    {/* Sidebar */}
                <div className={`${isMobileMenuOpen ? 'flex' : 'hidden md:flex'} w-full md:w-64 border-b md:border-b-0 md:border-r border-[#e5e7eb] p-4 flex-col gap-1 overflow-y-auto whitespace-nowrap bg-white shrink-0 tracking-tight`}>
                  {(adminRole === 'superadmin') && (
                    <div className="mb-4">
                      <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest pl-3 mb-2 hidden md:block">System</div>
                      <button onClick={() => { setActiveTab('theme'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'theme' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Palette size={16} /> Theme
                      </button>
                      <button onClick={() => { setActiveTab('branding'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'branding' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <ImageIcon size={16} /> Branding
                      </button>
                      <button onClick={() => { setActiveTab('admins'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'admins' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <ShieldCheck size={16} /> Admins
                      </button>
                      <button onClick={() => { setActiveTab('users'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'users' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Users size={16} /> Users
                      </button>
                      <button onClick={() => { setActiveTab('system_tools'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'system_tools' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                  ...
                  {(adminRole === 'superadmin' || adminRole === 'contenteditor') && (
                    <div className="mb-4 text-left">
                      ...
                      <button onClick={() => { setActiveTab('about'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'about' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Info size={16} /> About
                      </button>
                      <button onClick={() => { setActiveTab('capabilities'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'capabilities' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Zap size={16} /> Core Capabilities
                      </button>
                      <button onClick={() => { setActiveTab('translations'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'translations' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Languages size={16} /> Translations
                      </button>
                      <button onClick={() => { setActiveTab('portfolio'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'portfolio' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Briefcase size={16} /> Portfolio
                      </button>
                      <button onClick={() => { setActiveTab('lab'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'lab' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <FlaskConical size={16} /> Lab / Experiments
                      </button>
                      <button onClick={() => { setActiveTab('press'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'press' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Newspaper size={16} /> Press & Media
                      </button>
                      <button onClick={() => { setActiveTab('collaborators'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'collaborators' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Users size={16} /> Collaborators
                      </button>
                      <button onClick={() => { setActiveTab('contact'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'contact' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                  ...
                  {(adminRole === 'superadmin' || adminRole === 'formadmin') && (
                    <div className="mb-4 text-left">
                      ...
                      <button onClick={() => { setActiveTab('forms'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'forms' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <FileText size={16} /> Forms & Events
                      </button>
                      <button onClick={() => { setActiveTab('applications'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'applications' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                        <Inbox size={16} /> Applications (CRM)
                      </button>
                      <button onClick={() => { setActiveTab('certificates'); setIsMobileMenuOpen(false); }} className={`w-full flex items-center gap-3 text-left px-3 py-2 rounded-lg text-sm transition-colors ${activeTab === 'certificates' ? 'bg-[#fff0f0] text-[#fe0000] font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-black'}`}>
                ...
                <div className="flex-1 overflow-hidden flex flex-col">
                  <div className="flex-1 overflow-y-auto p-6 md:p-8" data-lenis-prevent="true">
                      ...
                      {!selectedFormForApps ? (
                        ...
                        <div className="space-y-4 flex flex-col h-full">
                          ...
                          <div className="flex gap-2 border-b border-[#e5e7eb] pb-2 font-mono text-sm overflow-x-auto shrink-0 w-full" data-lenis-prevent="true">
                            ...
                            >
                              New ({applications.filter(r => (r.status || 'applied') === 'applied').length})
                            </button>
                            <button
                            ...
                            >
                              Approved ({applications.filter(r => ['approved', 'participated', 'missed'].includes(r.status)).length})
                            </button>
                            <button
                            ...
                            >
                              Rejected ({applications.filter(r => r.status === 'rejected').length})
                            </button>
                            <button
                            ...
                            >
                              Finalists ({applications.filter(r => r.status === 'finalized').length})
                            </button>
                            <button
                              onClick={() => setAppStatusFilter('deleted')}
                              className={`px-4 py-2 rounded-t transition-colors whitespace-nowrap ${appStatusFilter === 'deleted' ? 'bg-[#f9fafb] border border-b-0 border-[#e5e7eb] font-bold text-purple-700' : 'text-gray-500 hover:text-black'}`}
                            >
                              Trash Bin ({applications.filter(r => r.status === 'deleted').length})
                            </button>
                          </div>
                                ...
                                <tbody className="divide-y divide-[#e5e7eb]">
                                  {loadingApps && applications.length === 0 ? (
                                    <tr>
                                      ...
                                      if (appStatusFilter === 'deleted' && stat !== 'deleted') return false;
                                      return true;
                                    }).length === 0 ? (
                                    <tr>
                                      <td colSpan={4} className="px-4 py-8 text-center text-[#6b7280]">
                                    ...
                                    applications
                                      ...
                                      .map((app) => {
                                      let submitter = '';
                                      const defaultName = app.name || (app.formData?.Name && app.formData?.Surname 
                                          ? `${app.formData.Name} ${app.formData.Surname}` 
                                          : app.formData?.Name);
                                      ...
                                      if (app.profileName || app.profileSurname) {
                                          ...
                                          if (defaultName) {
                                              submitter += ` (Form: ${defaultName})`.trim();
                                          }
                                      } else {
...
showToast('Application moved to approved');
                                          ...
                                          {appStatusFilter !== 'deleted' ? (
                                            <button
                                              onClick={async () => {
                                                if (window.confirm('Are you sure you want to move this response to the Trash Bin?')) {
                                                  try {
                                                    await updateDoc(doc(db, 'volunteerApplications', app.id), { status: 'deleted' });
                                                    updateLocalAppStatus(app.id, 'deleted');
                                                    showToast('Application moved to Trash Bin');
                                                  } catch (err) {
                                              ...
                                              className="text-xs bg-red-100 text-red-600 px-3 py-1.5 rounded hover:bg-red-200 transition-colors mt-2 md:mt-0 uppercase tracking-wider"
                                            >
                                              Delete
                                            </button>
                                          ) : (
                                            <>
                                              <button
                                                onClick={async () => {
                                                  if (window.confirm('Restore this response to New (Pending)?')) {
                                                    try {
                                                      await updateDoc(doc(db, 'volunteerApplications', app.id), { status: 'applied' });
                                                      updateLocalAppStatus(app.id, 'applied');
                                                      showToast('Application restored');
                                                    } catch (err) {
                                                      console.error('Error recovering application:', err);
                                                      showToast('Failed to recover application');
                                                    }
                                                  }
                                                }}
                                                className="text-xs bg-blue-100 text-blue-700 px-3 py-1.5 rounded hover:bg-blue-200 transition-colors mt-2 md:mt-0 mr-2 uppercase tracking-wider"
                                              >
                                                🔄 Recover
                                              </button>
                                              <button
                                                onClick={async () => {
                                                  if (window.confirm('Are you sure you want to PERMANENTLY delete this response? This action cannot be undone!')) {
                                                    try {
                                      ...
                                      {appStatusFilter !== 'deleted' ? (
                                        ...
                                        <>
                                          <button
                                            ...
                                            className="text-xs bg-blue-100 text-blue-700 px-3 py-2 rounded hover:bg-blue-200 transition-colors uppercase tracking-wider"
                                          >
                                            🔄 Recover
                                          </button>
                                          <button
                      ...
                      {loadingUserApplications ? (
                         ...
                         <div className="space-y-2 mt-2">
                           {selectedUserApplications.map(app => (
                             <div key={app.id} className="flex justify-between items-center bg-white p-2 border border-[#e5e7eb] rounded">
                               <div>
        ...
        {selectedApplication && (
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-6 font-mono text-sm text-gray-900 overflow-y-auto flex-1 custom-scrollbar" data-lenis-prevent="true">
