      ...
      <AnimatePresence>
        {isAboutOpen && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            className="fixed inset-0 bg-[var(--color-bg)] z-[100] overflow-y-auto overscroll-contain block" data-lenis-prevent="true"
          >
            ...
            <div className="min-h-full p-6 md:p-12 flex flex-col relative z-10 pb-24">
      ...
      <AnimatePresence>
        {infoModal && (
          <motion.div
            ...
            className="fixed inset-0 bg-[var(--color-bg)] z-[100] overflow-y-auto overscroll-contain block p-6" data-lenis-prevent="true"
          >
            <div className="absolute inset-0 bg-[linear-gradient(to_right,var(--color-border)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border)_1px,transparent_1px)] bg-[size:4rem_4rem] pointer-events-none opacity-20" />
